    ...
    def _prepare_initial_signal_values(self):
        ...
        for signal in self.database.signals:
            ...
            if signal.initial:
                ...
                value = (signal.initial * signal.decimal.scale) + signal.decimal.offset
                transform = float if signal.is_float else round
                initial_sig_values[signal.name] = transform(value)
